   ...
   function DrawCaptcha()
    {
        ...
        document.signup.txtCaptcha.value = code
    }
...
<body>
  <div id="stylized" class="myform">
       <form id="form" name="signup" method="post" action="signup.php" onload="DrawCaptch();">
    ...
    <fieldset>
		...
		<input type="button" id="btnrefresh" value="Click to Load Captcha" onclick="DrawCaptcha();" style="width:150px;height:47px"  />		
		<input type="text" id="txtCaptcha" name="txtCaptcha" readonly="yes" onblur="DrawCaptcha();" style="background-image:url(images/optimized/1.jpg); text-align:center; border:none; font-family:'mistral'; height:40px;font-size:40px" />
		<br />
		<br />
		<br />
		<br />
		<br />
		<label>Enter Captcha :
		<span class="small">Type Appeared Word</span>		</label>
		<input type="text" id="txtInput" name="txtInput" style="width:175; height:20px; margin-left: 35px;"/>  
		<br/>
		<br/>
