...
if($_POST['ssemester']!="semester")
{
	...
	{
	unset($_SESSION['mba']);
		$papquery="SELECT * from papers where stream=\"mba\" and semester=\"$semester\"";
      ...
      <?php require_once("lib/lib_container5_useful_links.php"); ?>
       ...
       <div id="content">
         ...
         <h1> Select your preferred choice: </h1>
           ...
           <hr />
            <br />
        <form id="contact" action="mbapap.php" name="mbaform" method="post">
